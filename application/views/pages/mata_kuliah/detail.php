    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="float-right">
          <a href="<?= base_url(); ?>Mata_kuliah/update/<?= $mata_kuliah['kode']; ?>" class="btn btn-warning">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?= base_url(); ?>Mata_kuliah/delete/<?= $mata_kuliah['kode']; ?>" class="btn btn-outline-danger">Ya</a>
